...
{
    if ( strcmp(symbol,"GAME") == 0 || strcmp(symbol,"GIN") == 0 || strcmp(symbol,"EMC2") == 0 || strcmp(symbol,"ZECTEST") == 0 || strcmp(symbol,"AYA") == 0 || strcmp(symbol,"GLEEC") == 0 || strcmp(symbol,"SFUSD") == 0)
        return(1);
    else return(0);
}
