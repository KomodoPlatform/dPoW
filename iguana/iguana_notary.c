...
char NOTARY_CURRENCIES[][65] = {
    "REVS", "SUPERNET", "DEX", "PANGEA", "JUMBLR", "BET", "CRYPTO", "HODL", "BOTS", "MGW", "COQUICASH", "WLC", "KV", "MESH", "MSHARK", "AXO", "ETOMIC", "BTCH", "NINJA", "OOT", "ZILLA", "RFOX", "SEC", "CCL", "PIRATE", "PGT", "KSB", "OUR", "ILN", "RICK", "MORTY", "HUSH3", "KOIN", "ZEXO", "K64", "THC", "WLC21", "VOTE2020"
};
